...
def plot_all_features():
  ...
  for idx_f1, (feature_name_f1, feature_value_f1) in enumerate(dict_csv_per_feature.items()): 
    for idx_f2, (feature_name_f2, feature_value_2) in enumerate(dict_csv_per_feature.items()):
      if idx_f1 != idx_f2 :
        plot_two_features(dict_csv_per_feature, feature_name_f1, feature_name_f2) 
